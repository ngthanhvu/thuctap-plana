                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="brand in brands" :key="brand.id">
                                <td class="py-3 ps-4">
                                    <div class="flex items-center h-5">
                                        <input :id="'hs-table-checkbox-' + brand.id" type="checkbox"
                                            class="border-gray-200 rounded-sm text-blue-600 focus:ring-blue-500">
                                        <label :for="'hs-table-checkbox-' + brand.id" class="sr-only">Checkbox</label>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <img :src="brand.logo" alt="Brand logo" class="h-8 w-auto">
                                </td>
